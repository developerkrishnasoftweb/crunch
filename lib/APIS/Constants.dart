...
class SQFLiteTables {
  ...
  static void setDatabase () async {
    databasePath = await getDatabasesPath();
    db = await openDatabase(databasePath + 'myDb.db', version: 1, onCreate: (Database db, int version) async {});
  }
  ...
  static dynamic insertData () async {
