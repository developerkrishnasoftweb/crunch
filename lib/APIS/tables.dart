  ...
  static Future<List<Map<String, dynamic>>> getData({Tables table}) async {
    switch (table) {
      ...
      case Tables.DISCOUNTS:
        ...
        break;
      case Tables.ITEMS:
        return db.rawQuery("select * from `$tableItems` where `active` = '1'");
        break;
      case Tables.ORDER_TYPE:
